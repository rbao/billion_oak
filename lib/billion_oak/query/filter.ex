defmodule BillionOak.Query.Filter do
  @moduledoc """
  ```
  [
    %{"$and" => [
  ...
  import Ecto.Query
  import BillionOak.Normalization, only: [stringify_list: 1]
  ...
  defp compare_attr(attr, value) when is_list(value) do
  ...
  defp assoc(field) do
    ...
    assoc_field = Enum.join(Enum.slice(splitted, 1..-1//-1), ".")
